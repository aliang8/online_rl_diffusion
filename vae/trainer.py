...
class Trainer:
    def __init__(self, config):
        ...
        def loss_fn(params, rng_key, input, entropy_weight):
            ...
            kl_loss = 0.5 * jnp.sum(
                -jnp.log(var) - 1.0 + var + jnp.square(mean), axis=-1
            )
            ...
            elbo_loss = recon_loss + config.kl_weight * kl_loss
            ...
            # return elbo, metrics
            # return elbo_loss.mean(), metrics
            return pg_loss.mean(), metrics
